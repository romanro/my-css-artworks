        ...
        <div className={cnames(['relative flex justify-center items-center h-screen w-screen'])}>
            <div className='flex justify-center w-full max-h-[100%] overflow-y-auto '>
                <article
                    className={cnames([
                        'info-article',
                        'flex text-blue-900 flex-col gap-4 p-4 pt-[100px] md:p-12 md:pt-[200px]  max-w-screen-xl mx-auto bg-white/20 dark:bg-black/20 h-[100%]',
                    ])}>
                    ...
                    <h2>My Journey</h2>
                    <p>
                        With a background in graphic design, animation, and web development, I’ve always been fascinated
                        by how technology and creativity intersect.
                    </p>
                    <p>
                        Over the years, I’ve honed my skills in crafting seamless, optimized, and visually compelling
                        web solutions that not only function well but also tell a story.
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            Tips & Techniques: Insights into how I create visual magic with clean and efficient code.
                        </li>
                    </ul>
                    <h2>Beyond Code</h2>
